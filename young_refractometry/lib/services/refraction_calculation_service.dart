...
//     final accuracy = (correctResponses.length / responses.length) * 100;
    
//     // Find the MINIMUM blur level where user FAILED (vision threshold)
//     double minFailBlur = 10.0; // Start with max
...
//     // Find the MAXIMUM blur level where user SUCCEEDED
...
//     // Calculate sphere based on visual acuity threshold
//     // KEY INSIGHT: Higher maxSuccessBlur = BETTER vision = LESS negative power
//     // If user can see clearly even with HIGH blur → Good vision → Low/No power
//     double sphere = 0;
    
//     if (accuracy == 100) {
//       // Perfect accuracy - vision is excellent
//       // The higher the blur they tolerated, the better their vision
//       if (maxSuccessBlur >= 8.0) {
//         sphere = 0.00;  // Plano - excellent vision, no correction needed
//       } else if (maxSuccessBlur >= 7.0) {
//         sphere = -0.25; // Minimal myopia
//       } else if (maxSuccessBlur >= 6.0) {
//         sphere = -0.50;
//       } else if (maxSuccessBlur >= 5.0) {
//         sphere = -0.75;
//       } else {
//         sphere = -1.00;
//       }
//     } else if (accuracy >= 85) {
//       // Very good accuracy
//       if (maxSuccessBlur >= 7.0) {
//         sphere = -0.25;
//       } else if (maxSuccessBlur >= 5.0) {
//         sphere = -0.75;
//       } else if (maxSuccessBlur >= 3.0) {
//         sphere = -1.25;
//       } else {
//         sphere = -1.75;
//       }
...
//       // Good accuracy
//       if (minFailBlur < 10.0) {
//         // Failed at some point - use failure threshold
//         if (minFailBlur >= 5.0) {
//           sphere = -1.00;
//         } else if (minFailBlur >= 3.0) {
//           sphere = -1.75;
//         } else {
//           sphere = -2.50;
//         }
...
//       if (minFailBlur >= 4.0) {
//         sphere = -2.00;
//       } else if (minFailBlur >= 2.0) {
//         sphere = -3.00;
//       } else {
//         sphere = -4.00;
//       }
//     } else {
//       // Poor accuracy - significant vision issues
//       sphere = -4.00;
//     }

//     // Calculate cylinder and axis (astigmatism detection)
//     // Count correct answers by direction
//     final leftCorrect = responses.where((r) => r.direction == 'left' && r.correct).length;
//     final rightCorrect = responses.where((r) => r.direction == 'right' && r.correct).length;
//     final upCorrect = responses.where((r) => r.direction == 'up' && r.correct).length;
//     final downCorrect = responses.where((r) => r.direction == 'down' && r.correct).length;
    
//     final leftTotal = responses.where((r) => r.direction == 'left').length;
//     final rightTotal = responses.where((r) => r.direction == 'right').length;
//     final upTotal = responses.where((r) => r.direction == 'up').length;
//     final downTotal = responses.where((r) => r.direction == 'down').length;

//     // Calculate accuracy by orientation
//     double horizontalAccuracy = 0;
//     if (leftTotal + rightTotal > 0) {
//       horizontalAccuracy = ((leftCorrect + rightCorrect) / (leftTotal + rightTotal)) * 100;
//     }
    
//     double verticalAccuracy = 0;
//     if (upTotal + downTotal > 0) {
//       verticalAccuracy = ((upCorrect + downCorrect) / (upTotal + downTotal)) * 100;
//     }

//     double cylinder = 0;
//     int axis = 0;
    
//     // Detect astigmatism from directional performance difference
//     final accuracyDiff = (horizontalAccuracy - verticalAccuracy).abs();
    
//     if (accuracyDiff >= 40) {
//       cylinder = -1.25;
//     } else if (accuracyDiff >= 30) {
//       cylinder = -1.00;
...
//         axis = 90;  // Horizontal vision worse - correct at 90°
//       } else {
//         axis = 180; // Vertical vision worse - correct at 180°
//       }
//     }

//     return EyeResult(
//       eye: eye,
//       sphere: sphere.toStringAsFixed(2),
//       cylinder: cylinder.toStringAsFixed(2),
//       axis: axis,
//       accuracy: accuracy.toStringAsFixed(1),
//       avgBlur: maxSuccessBlur.toStringAsFixed(2),
//     );
//   }
// }
import '../models/test_response.dart';
