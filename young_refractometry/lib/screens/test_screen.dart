...
//                 mainAxisAlignment: MainAxisAlignment.center,
//                 children: [
//                   _buildDirectionButton(Icons.arrow_back, 'LEFT', () => _handleResponse('left')),
//                   const SizedBox(width: 90),
//                   _buildDirectionButton(Icons.arrow_forward, 'RIGHT', () => _handleResponse('right')),
//                 ],
//               ),
//               const SizedBox(height: 10),
...
//   int currentRound = 1;
//   double currentSize = 150.0; // Starting size
//   String currentEye = 'OD'; // Right eye
//   int correctAnswers = 0;
  
//   // E rotation angles (in radians)
//   List<double> rotations = [0, math.pi / 2, math.pi, 3 * math.pi / 2]; // Up, Right, Down, Left
...
//   void _randomizeRotation() {
//     setState(() {
//       currentRotation = (rotations..shuffle()).first;
//     });
//   }

//   String _getExpectedDirection() {
//     if (currentRotation == 0) return 'UP';
//     if (currentRotation == math.pi / 2) return 'RIGHT';
//     if (currentRotation == math.pi) return 'DOWN';
//     return 'LEFT';
//   }

//   void _handleAnswer(String direction) {
//     if (direction == _getExpectedDirection()) {
//       correctAnswers++;
//     }
...
//         currentSize = math.max(20, 150 - (currentRound * 5));
//       });
//       _randomizeRotation();
//     } else {
//       // Test complete - show results
//       final provider = Provider.of<TestProvider>(context, listen: false);
//       provider.setScreen('results');
//     }
//   }
...
//                       Row(
//                         children: [
//                           Icon(Icons.visibility, color: Colors.blue[700], size: 28),
//                           const SizedBox(width: 8),
//                           Text(
//                             'Right Eye (OD)',
//                             style: TextStyle(
...
//             // E Letter Display - FIXED VERSION
//             Expanded(
//               child: Center(
//                 child: Container(
...
//                         style: TextStyle(
//                           fontFamily: 'Monospace',
//                           fontSize: 300, // Large size - FittedBox will scale it down
//                           fontWeight: FontWeight.w900,
//                           color: Colors.black,
//                           letterSpacing: 0,
...
//               padding: const EdgeInsets.symmetric(vertical: 12),
//               child: Text(
//                 'Size: ${currentSize.toInt()}px  •  Blur: 0.5',
//                 style: TextStyle(
//                   fontFamily: 'Monospace',
//                   fontSize: 12,
//                   color: Colors.grey[600],
...
//             // Can't See Clearly button
//             Padding(
//               padding: const EdgeInsets.symmetric(horizontal: 20),
//               child: OutlinedButton(
//                 onPressed: () {
//                   // Handle can't see clearly
//                   _handleAnswer('UNCLEAR');
//                 },
//                 style: OutlinedButton.styleFrom(
